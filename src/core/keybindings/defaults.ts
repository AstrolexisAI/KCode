...
export const DEFAULT_BINDINGS: KeyBinding[] = [
  ...
  {
    action: "newline",
    chord: parseKeyChord("shift+enter"),
    source: "default",
  ...
  {
    action: "toggle.theme",
    chord: parseKeyChord("ctrl+k ctrl+t"),
    source: "default",
    description: "Toggle theme",
  },
  {
    action: "toggle.vim",
    chord: parseKeyChord("ctrl+k ctrl+v"),
    source: "default",
    description: "Toggle vim mode",
  },
  {
    action: "toggle.verbose",
    chord: parseKeyChord("ctrl+k ctrl+d"),
    source: "default",
    description: "Toggle verbose",
  },
  {
    action: "search.messages",
    chord: parseKeyChord("ctrl+k ctrl+f"),
    source: "default",
    description: "Search messages",
  },
  {
    action: "pin.file",
    chord: parseKeyChord("ctrl+k ctrl+p"),
    source: "default",
    description: "Pin file",
  },
  {
    action: "show.cost",
    chord: parseKeyChord("ctrl+k ctrl+c"),
    source: "default",
    description: "Show cost summary",
  },
  {
    action: "model.switch",
    chord: parseKeyChord("ctrl+k ctrl+m"),
    source: "default",
  ...
  {
    action: "cancel",
    chord: parseKeyChord("escape"),
    source: "default",
    description: "Cancel response",
  },
  {
    action: "permission.cycle",
    chord: parseKeyChord("shift+tab"),
    source: "default",
