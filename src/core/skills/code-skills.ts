...
**Your audit will be read by security-conscious engineers. Earn their trust with precision.**`,
  ...
  {
    name: "dart",
    description: "Create a Dart/Flutter project (mobile, web, CLI, server, library)",
    aliases: ["flutter", "create-dart"],
    args: ["description of the project"],
    template: `__builtin_dart__`,
  },
  {
    name: "lua",
    description: "Create a Lua project (Love2D game, Neovim plugin, Roblox, server, script)",
    aliases: ["create-lua", "love2d", "neovim-plugin"],
    args: ["description of the project"],
    template: `__builtin_lua__`,
  },
  {
    name: "haskell",
    description: "Create a Haskell project (Scotty/Servant API, CLI, library)",
    aliases: ["hs", "create-haskell"],
    args: ["description of the project"],
    template: `__builtin_haskell__`,
  },
  {
    name: "scala",
    description: "Create a Scala project (http4s API, Spark, CLI, library)",
    aliases: ["create-scala", "spark"],
    args: ["description of the project"],
    template: `__builtin_scala__`,
  },
  {
    name: "terraform",
    description: "Create a Terraform/IaC project (AWS, GCP, Azure, Kubernetes)",
    aliases: ["tf", "create-terraform", "iac", "infra"],
    args: ["description of infrastructure"],
    template: `__builtin_terraform__`,
  },
  {
    name: "monorepo",
    description: "Create a monorepo (Turborepo/Nx with multiple packages)",
    aliases: ["create-monorepo", "turborepo", "nx"],
    args: ["description of the workspace"],
    template: `__builtin_monorepo__`,
  },
  {
    name: "cicd",
    description: "Create CI/CD pipelines (GitHub Actions, GitLab CI, Jenkins)",
    aliases: ["ci", "pipeline", "create-cicd", "github-actions"],
    args: ["description of the pipeline"],
    template: `__builtin_cicd__`,
  },
  {
    name: "db",
