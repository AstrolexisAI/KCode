...
`, needsLlm: false });
  ...
  if (cfg.type === "api" && cfg.framework === "ktor") {
    // Item model
    files.push({ path: `src/main/kotlin/${pkgPath}/model/Item.kt`, content: `package ${cfg.pkg}.model
...
`, needsLlm: false });
    ...
    // Item repository
    files.push({ path: `src/main/kotlin/${pkgPath}/repository/ItemRepository.kt`, content: `package ${cfg.pkg}.repository
...
`, needsLlm: false });
    ...
    // Routes
    files.push({ path: `src/main/kotlin/${pkgPath}/routes/ItemRoutes.kt`, content: `package ${cfg.pkg}.routes
