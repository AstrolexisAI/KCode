  ...
  },
  {
    ...
    settings: {
      ...
      systemPromptAppend: [
        ...
        "",
        "DO NOT call EnterPlanMode — it is blocked here. Just read files and write ONE report.",
        "DO NOT create multiple report files. Exactly ONE file: AUDIT_REPORT.md. No README_AUDIT, no AUDIT_INDEX, no REMEDIATION_FIXES, no PROJECT_ANALYSIS_SUMMARY. If you create more than one file you have failed.",
        "",
