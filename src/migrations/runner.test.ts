...
describe("Migration Registry", () => {
  test("ALL_MIGRATIONS contains migrations in order", () => {
    expect(ALL_MIGRATIONS).toHaveLength(7);
    ...
    expect(ALL_MIGRATIONS[5]!.version).toBe("006");
    expect(ALL_MIGRATIONS[6]!.version).toBe("007");
  });
